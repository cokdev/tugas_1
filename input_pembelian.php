...
<div class="container" style="margin-top: 10px;">
    <div class="row">
        <form class="col s12" action="proses_simpan.php" method="POST">
            <div class="row">
                <div class="input-field col s6">
                    <i class="material-icons prefix">border_color</i>
                    <input id="kd_transaksi" name="kd_transaksi" type="text">
                    <label for="kd_transaksi">Kode Transaksi</label>
                </div>
                <div class="input-field col s6">
                    <i class="material-icons prefix">bookmark</i>
                    <input id="kd_barang" name="kd_barang" type="text">
            ...
            <div class="row">
                ...
                <div class="input-field col s4">
                    <input id="jlh_beli" name="jlh_beli" type="text">
                    <label for="jlh_beli">Jumlah Beli</label>
                </div>
            </div>

            <div class="row">
                <button class="btn waves-effect waves-light" type="submit" name="action">SUBMIT DATA
